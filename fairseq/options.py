...
def add_crd_args(parser):
    ...
    # fmt: off
    group.add_argument('--teacher_model_arch', '--tma', default='roberta_base', type=str, metavar='N',
                       help='teacher model arch')
    group.add_argument('--teacher_model_checkpoint', '--tmc', default=None, type=str, metavar='N',
                       help='teacher model arch checkpoint directory name')
    group.add_argument('--teacher_model_pt', '--tmp', default='model.pt', type=str, metavar='N',
                       help='teacher model arch checkpoint pt file')
    group.add_argument('--data_name_or_path', '--dnp', default='', type=str, metavar='N',
                       help='data name or path to load teacher model')
    group.add_argument('--temperature', '--temp', default=1, type=float, metavar='N',
                       help='teacher model arch checkpoint')
    group.add_argument('--kd_weight', '--kw', default=1, type=float, metavar='N',
                       help='kd loss weight, default is 1')
    group.add_argument('--crd_weight', '--cw', default=0.0, type=float, metavar='N',
                       help='crd loss weight, default is 0')
    group.add_argument('--nce_k', '--nk', default=100, type=int, metavar='N',
                       help='number of negative samples')
    group.add_argument('--s_dim_feat', '--sdf', default=4608, type=int, metavar='N',
                       help='number of feats in student')
    group.add_argument('--t_dim_feat', '--tdf', default=4608, type=int, metavar='N',
                       help='number of feats in teacher')
    group.add_argument('--s_dim_attn', '--sda', default=36504, type=int, metavar='N',
                       help='number of attns in student')
    group.add_argument('--t_dim_attn', '--tda', default=36504, type=int, metavar='N',
                       help='number of attns in teacher')
    group.add_argument('--crd_feat_dim', '--cfd', default=128, type=int, metavar='N',
                       help='feat dim for CRD')
